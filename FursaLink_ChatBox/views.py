...
def chat_room(request):
    ...
    return render(request, 'Login_System/fursalink_chat.html', {'messages': messages})
...
def send_ai_message(request):
    ...
    if request.method == 'POST':
        ...
        if api_key and requests:
            try:
                system_prompt = (
                    "You are a concise assistant for the FursaLink platform. Use any provided local resources to ground your answer. "
...
def generate_ai_response(content, user):
    ...
    if "hello" in content or "hi" in content:
        return f"Hello {user.username}! I am your FursaLink Assistant. How can I help you with scholarships, jobs, or Irembo services today?"
        ...
        res += "1. Complete your FursaLink profile.\n"
